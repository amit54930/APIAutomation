...
var config_fetchAuthorizationDataofUser = config.fetchAuthorizationDataofUser;
...
//Web service URL
var url = config.service_auth_root_url+config_fetchAuthorizationDataofUser.call_suffix_toFetchAuthDataofUser;
...
// console.log("URL: " + url);
  ...
  var options = {headers:testData.Authorization}
