...
var config_AssignSingleCaseToSingleAnalyst = config.AssignSingleCaseToSingleAnalyst;
...
//Web service URL
var url = config.service_queue_manager_url+config_AssignSingleCaseToSingleAnalyst.call_Suffix_toAssignSingleCaseToSingleAnalyst;
//console.log("HHHHHHHHHHHHHHHHHHHHHHHHHHHHH"+url);
...
function template1_success(object, testData, url) {
  ...
  //console.log(url);
      var options = {headers: config.header, json: testData.caseAssignmentDataRequestList};
     //console.log(options);
