...
var config_AssignMultipleCaseToMultipleAnalyst = config.AssignMultipleCaseToMultipleAnalyst;
...
//Web service URL
var url = config.service_queue_manager_url+config_AssignMultipleCaseToMultipleAnalyst.call_Suffix_toAssignMultipleCaseToMultipleAnalyst;
...
function template1_success(object, testData, url) {
  ...
  //console.log(url);
      var options = {headers: config.header, json: testData.caseAssignmentRegionDataRequest};
     //console.log(options);
