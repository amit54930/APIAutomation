...
var config_AssignMultipleCaseToSingleAnalyst = config.AssignMultipleCaseToSingleAnalyst;
...
//Web service URL
var url = config.service_queue_manager_url+config_AssignMultipleCaseToSingleAnalyst.call_Suffix_toAssignMultipleCaseToSingleAnalyst;
...
function template1_success(object, testData, url) {
  ...
  //console.log(url);
      var options = {headers: config.header, json: testData.caseAssignmentBulkData};
     //console.log(options);
