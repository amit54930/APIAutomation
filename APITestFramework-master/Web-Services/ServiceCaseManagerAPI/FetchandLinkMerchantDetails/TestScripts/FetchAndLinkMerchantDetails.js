...
var config_FetchAndLinkMerchantDetails = config.FetchAndLinkMerchantDetailsAPI;
...
//Web service URL
var url = config.servicecasemanager_root_url+config_FetchAndLinkMerchantDetails.call_suffix_toFetchAndLinkMerchantDetails;
...
function template1_success(object, testData, url) {
  ...
  var options = { headers: config.header, json: testData.caseNumbers }
