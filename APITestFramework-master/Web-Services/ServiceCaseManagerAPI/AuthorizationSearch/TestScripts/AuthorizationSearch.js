...
var config_AuthorizationSearchAPI = config.AuthorizationSearchAPI;
...
//Web service URL
var url = config.servicecasemanager_root_url+config_AuthorizationSearchAPI.call_suffix_toAuthorizationSearch;
...
//console.log(options);
 ...
 // console.log("Status Code Matched");
  ...
  if (response.statusCode = 200) {
    ...
    expected_response=JSON.parse(expected_response)[0];
    //console.log("ACTUAL: " + JSON.stringify(actual2));
    utils.VerifyResponseBody(object, actual2, expected_response,['authTime','cardHolderNumberMask','posEntryModeDesc','referenceAuthorizationId','fnsDate','fnsCounter','expiryDate']);
