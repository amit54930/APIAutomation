...
var config_ReferenceAuthDataAPI = config.ReferenceAuthDataAPI;
...
eventEmitter.on("testCaseData", function (testCaseData) {
  ...
  it(execution_group, function () {
    var url = root_url + config_ReferenceAuthDataAPI.call_suffix_toFetchAuthorizationData;
...
function template_GET200 (object, testData, url) {
  ...
  if (response.statusCode = 200) {
   ...
   // console.log(actual2);
    utils.VerifyResponseBody(object, actual2,JSON.parse(expected_response), ['authTime','referenceAuthorizationId', 'etlBatchId', 'currencyCode',
