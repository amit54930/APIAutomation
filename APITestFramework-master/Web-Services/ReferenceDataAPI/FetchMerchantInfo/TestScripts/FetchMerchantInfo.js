...
var config_FetchMerchantInfoAPI = config.FetchMerchantInfoAPI;
...
var url = config.reference_root_url + config_FetchMerchantInfoAPI.call_suffix_toFetchMerchantData ;
...
function template1_success(object, testData, url) {
  ...
  var options = {
    ...
    qs: {merchantNumber:testData.merchantNumber}
 ...
 /*
  ...
  if (!queries.length == 0) {
    ...
    expected_response = JSON.stringify(obj);
