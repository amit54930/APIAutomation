...
var config_fetchListOfDisputeStatusAPI= config.FetchListOfDisputeStatusAPI;
...
//Web service URL
var root_url = config.servicecasedata_root_url+config_fetchListOfDisputeStatusAPI.call_suffix_tofetchListOfDisputeStatus;
...
var obj = JSON.parse(expected_response)[i];
      Object.keys(obj).forEach(function (key) {
        ...
        result[i]=obj;
        var statusId= parseInt(result[i].statusId);
        result[i].statusId=statusId;
    }
