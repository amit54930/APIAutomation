...
var config_InsertunmatchedCaseDetailsAPI = config.InsertunmatchedCaseDetailsAPI;
...
eventEmitter.on("testCaseData", function (testCaseData) {
  url=root_url+config_InsertunmatchedCaseDetailsAPI.call_suffix_toInsertunmatchedCaseDetails;
 // console.log(url);
