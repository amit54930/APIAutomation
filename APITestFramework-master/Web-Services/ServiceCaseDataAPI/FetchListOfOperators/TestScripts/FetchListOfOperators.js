...
var config_FetchListOfOperators= config.FetchListOfOperators;
...
//Web service URL
var root_url = config.servicecasedata_root_url + config_FetchListOfOperators.call_suffix_toFetchListOfOperators;
...
var userId= parseInt(expected.userId);
...
// console.log("______________databaSE_________________________"+JSON.stringify(result));
 ...
 //console.log(actual2);
 //console.log(result);
utils.VerifyResponseBody(object,actual2,expected_response,['emailId','status','fullName']);
  } else {
