...
var config_InsertStripOffMerchantAPI = config.InsertStripOffMerchantAPI;
...
//Web service URL
var url = config.service_merchant_category_root_url+config_InsertStripOffMerchantAPI.call_suffix_toInsertStripOffMerchant;
...
function template1_success(object, testData, url) {
  ...
  if (!queries.length == 0) {
    ...
    var expected_response = Framework.dbValidator(queries,
      ...
      var merchantNumber=expected_response[0].merchant_number;
    testData.test.merchantNumber=merchantNumber;
    ...
    if(merchantNumber!=undefined){
      ...
      //testData.test.merchantNumber = "0000000"+"58754454";
    ...
    testData.test.merchantNumber = pad(merchantNumber,"16");
 ...
 // console.log("Status Code Matched");
  ...
  console.log("Warning...This document already existed..");
}
}
