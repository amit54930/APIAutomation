...
var config_BarcodeReadAPI = config.BarcodeReadAPI;
...
function template1_success(object, testData) {
  ...
  url = root_url+config_BarcodeReadAPI.call_suffix_toReadBarcode ;

  var options = { headers: config.header,qs: {absoluteFilePath:testData.absoluteFilePath} }
