...
var config_DeleteUserSavedSearchesAPI = config.DeleteUserSavedSearchesAPI;
...
//Web service URL
var url = config.service_search_filter_root_url+config_DeleteUserSavedSearchesAPI.call_suffix_toDeleteUserSavedSearches;
...
url=url.replace("{savedSearchId}",testData.savedSearchId);
var options = { headers: config.header,qs:{savedSearchId:testData.savedSearchId} }
